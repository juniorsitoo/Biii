...
window.addEventListener("load", () => {
  ...
  if (anniversaryDate) {
    ...
    document.getElementById(
      "daysCount"
    ).innerText = `Ya han pasado ${years} ${yearText}, ${months} ${monthText} y ${days} ${dayText}, desde que comenzó nuestra historia de una bonita amistad. Me alegra mucho de haber conocido a una personita muy especial como tu.¡Te ️quiero!`;
  }
});
...
const mensajes = [
    "Bueno como te dije ya antes eres una persona que le eh tenido un cariño muy especial en este poco tiempo que nos hemos conocido.... ",
    "Y ya sabes si necesitas algo ya sea bueno o malo....🌹",
    "Aqui estare para ti  😊",
    "Eres la mejor parte de mi día. ☀️",
    "Gracias por existir y la amistad brindada🫂💓",
];
